...
wget "https://vencord.dev/download/vesktop/amd64/appimage" -P "/home/ayabusa/PortableApps/vesktop.AppImage"
wget "https://github.com/ONLYOFFICE/appimage-desktopeditors/releases/latest/download/DesktopEditors-x86_64.AppImage" -P "/home/ayabusa/PortableApps/only-office.AppImage"
wget "https://github.com/Alex313031/thorium/releases/latest/download/Thorium_Browser_138.0.7204.303_AVX2.AppImage" -P "/home/ayabusa/PortableApps/thorium.AppImage" 
wget "https://github.com/ryanoasis/nerd-fonts/releases/latest/download/JetBrainsMono.zip" -P "/home/ayabusa/Downloads/JetBrainsMono.zip"
...
rm -f "/home/ayabusa/Downloads/JetBrainsMono.zip" 
fc-cache -f -v

echo "Installing Bibata cursors"
wget "https://github.com/ful1e5/Bibata_Cursor/releases/latest/download/Bibata-Modern-Classic.tar.xz" -P "/home/ayabusa/Downloads/cursor.tar.xz"
...
wget "https://github.com/Fausto-Korpsvart/Catppuccin-GTK-Theme/archive/refs/heads/main.zip" -P "/home/ayabusa/PortableApps/catpuccin_gtk.zip"
